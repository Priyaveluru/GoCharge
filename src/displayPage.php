        ...
        <nav>
          <ul class="nav nav-pills pull-right">
            <li role="presentation"><a href="udashboard.php">Home</a></li>
			 <li role="presentation" class="active"><a href="displayPage.php">Booking</a></li>
      ...
      <div class="jumbotron">
		...
		<form name="myform" method="post">
			...
			<?php	
				...
				echo '<td style="padding:20px;"><button type="submit" class="book_slot btn btn-xs btn-success"  data-slot='.$slotData[$i]['slot_id'].' name="submit" class="btn btn-default btn btn-xs btn-success pull-right" style="float:left;">Book Slot</button></td>';			  }
			?>
			</table>
			</div>
		 </div>
